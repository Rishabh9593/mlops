...
# If your model was trained with a single feature, 
# for example, you need to make sure the input data
# for prediction also has only one feature.
# For demonstration, let's assume the model expects 1 feature
X_new = np.array([[5]])  # Example: Input with 1 feature 

#(ensure this matches training data)

# If your model was trained with multiple features (e.g., 4 features), 
